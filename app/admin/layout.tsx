...
export default async function AdminLayout({ children }: LayoutProps<"/admin">) {
  ...
  return (
    <div className="min-h-screen bg-slate-100 lg:flex print:block print:bg-white">
      <aside className="no-print hidden w-60 shrink-0 flex-col bg-slate-900 px-3 py-5 lg:flex lg:min-h-screen">
      ...
      <header className="bg-slate-900 px-4 pt-3 lg:hidden no-print">
